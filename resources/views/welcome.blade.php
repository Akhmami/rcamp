                    ...
                    <div class="relative bg-white shadow-xl">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3">
                            ...
                            <div
                                ...
                                <p class="mt-6 text-base text-teal-50 max-w-3xl">untuk informasi lainnya bisa ditanyakan melalui kontak berikut.</p>
                                <dl class="mt-8 space-y-6">
                                    ...
                                    <dd class="flex text-base text-teal-50">
                                        ...
                                        <a href="//wa.me/6283811600697" target="_blank" class="ml-3 hover:underline">62838 1160 0697 (Ustzh Alfia)</a>
                                    </dd>
                            ...
                            <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                <h3 class="text-lg font-medium text-warm-gray-900">Daftarkan Sekarang</h3>
                                <livewire:register>
                            </div>
                        </div>
                    </div>
